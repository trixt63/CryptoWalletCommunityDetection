        ...
        for lp_addr, dex_id in lp_contracts.items():
            try:
                ...
                if not transaction_:
                    ...
                    lp_deployer_addr = transaction_['from'].lower()
                    ...
                    lp_deployer_addr = transaction_['from_address']
                # add wallet
                # TODO: too complicated & redundant
                if lp_deployer_addr in _lp_deployers:
                    _lp_deployers[lp_deployer_addr].add_protocol(protocol_id=dex_id,
                    ...
                    new_lp_owner_wallets.add_protocol(protocol_id=dex_id,
                                                      chain_id=self.chain_id,
                                                      address=lp_addr)
                    _lp_deployers[lp_deployer_addr] = new_lp_owner_wallets
