...
class LendingWalletsJob:
    ...
    def run(self):
        ...
        self._first_timestamp = round_timestamp(current_time - self.n_days*TimeConstants.A_DAY,
                                                TimeConstants.A_DAY)
    ...
    def _get_and_export_lending_wallets(self):
        ...
        for flagged in range(1, current_batch_id+1):
            ...
            logger.info(f"Flag {flagged}/{current_batch_id}: number of lending wallets: {len(batch_lending_wallets)}")
